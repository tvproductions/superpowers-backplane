...
| Pinned remote Git ref restoration | PASS | After PR #14 merged, the first package SHA and merge SHA were both reachable at origin. Native Git HEAD and three-skill fresh discovery passed at first, integrated, and restored first refs; the installation-reference hash changed and reverted. See integrated remote transcript. |
...
- Native installed-plugin discovery and current-cache behavioral conformance now pass for the tested native upstream mode. Sibling and absent-mode fresh setup are captured in [sibling and absent setup](transcripts/2026-09-19-codex-sibling-absent-setup.md). Integrated remote-ref discovery is now captured in [integrated remote verification](transcripts/2026-09-19-codex-integrated-remote.md). Issue #3 completion and fixture closure remain open; issue #3 is not complete.
...
## Post-integration remote verification

- PR #14 merged the reviewed feature head a060c82eed375d863e10432487010a2e3d6c007c into main at 40b7df7ec8ff477972ae2b9a8f87bdea0a0fb119. The original root-package SHA 8bfba888599568cc8f729ba6f0c030ace8e6377f and the merge SHA both resolved at the expected GitHub origin.
- In one disposable authenticated Codex profile, native Git marketplace installation at the first SHA, update to the merge SHA, and rollback to the first SHA each passed a separate fresh three-skill discovery session. Native marketplace HEAD matched the selected full SHA at every state. The installation reference hash changed from 5C7E05C03938717968B82FFB2E55CB2869F2C8C0DC71FFCA318BD0D9395C56CF to 50D82CCACBF71D368E983984157ABE91D1FAFD977F1F4D654C0FD58B5393329D and back, despite the unchanged 0.1.0 manifest version.
